...
template <> constexpr inline auto secondwindow::qt_create_metaobjectdata<qt_meta_tag_ZN12secondwindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "secondwindow",
        "on_pushButton_przelew_clicked",
        "",
        "on_pushButton_powrot_clicked",
        "on_pushButton_wykonaj_przelew_clicked",
        "on_pushButton_wyloguj_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_pushButton_przelew_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_powrot_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_wykonaj_przelew_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_wyloguj_clicked'
...
void secondwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushButton_przelew_clicked(); break;
        case 1: _t->on_pushButton_powrot_clicked(); break;
        case 2: _t->on_pushButton_wykonaj_przelew_clicked(); break;
